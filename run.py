...
move_resize_images(trains_folder, train_folder + '/train', train_percentage, new_size)
...
move_resize_images(trains_folder, validation_folder + '/train', validation_percentage, new_size)
...
move_resize_images(trains_folder, test_folder + '/train', test_percentage, new_size)
